    ...
    switch (type) {
      ...
      case AppThemeType.minimalLight:
        return AppThemeData(
          ...
          textSecondary: const Color(0xFF676E75),
          textMuted: const Color(0xFFA5ADB7),
          ...
          accentDim: const Color(0xFF387EAA),
          taskStandard: const Color(0xFF4A4E69),
          taskBlue: const Color(0xFF0066CC),
          taskYellow: const Color(0xFFF4A261),
          taskRed: const Color(0xFFE76F51),
          cardStandard: const Color(0xFFFFFFFF),
          cardBlue: const Color(0xFFF2F7FD),
          cardYellow: const Color(0xFFFFF9F3),
          cardRed: const Color(0xFFFFF5F2),
          glowBlue: const Color(0x1A0066CC),
          glowYellow: const Color(0x1AF4A261),
          glowRed: const Color(0x1AE76F51),
          borderRadius: 24.0,
          borderWidth: 0.0,
          useGlowBorder: false,
          glowShadow: (color, {intensity = 1.0}) => [
      ...
      case AppThemeType.ocean:
        return AppThemeData(
          ...
          border: const Color(0xFF00A8E8).withValues(alpha: 0.4),
          divider: const Color(0xFF145677),
          textPrimary: const Color(0xFFE0F2FE),
          textSecondary: const Color(0xFF7DD3FC),
          textMuted: const Color(0xFF0284C7).withValues(alpha: 0.5),
          ...
          accent: const Color(0xFF70E000),
          accentDim: const Color(0xFF55A900),
